...
public class LdosenFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        //isi dulu itemnya
        Toast.makeText(getContext(), "Refresh Layoutnya", Toast.LENGTH_SHORT).show();
